...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-cinnamon-theme-colloid"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-cinnamon-theme-colloid/iso-profile
"
echo
